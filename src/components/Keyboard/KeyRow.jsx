...
export default function KeyRow({ keys, middle, actions }) {
  return (
    <div className="flex w-full touch-manipulation mt-0 mx-auto mb-2 gap-1.5">
      {middle && <div className="flex-0.5" />}
      {actions && <Key spacer value="enter" />}
      {keys.map((key, index) => {
